    ...
    return (
        <div className='mt-10'>
            <div className='flex justify-center items-center'>
                <h1 className='text-4xl md:text-6xl text-primary'>How to Buy $tun</h1>
            </div>
            <div className='mt-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-start mx-10 lg:mx-32 xl:mx-48 2xl:mx-56 text-primary'>
                <div className='flex flex-col items-center text-center'>
                    ...
                    <p className='text-2xl mt-4'>You need a Solana wallet to BUY $tun</p>
                </div>
                ...
                <div className='flex flex-col items-center text-center'>
                    <h1 className='text-4xl'>Buy $tun</h1>
                    <p className='text-2xl mt-4'>Use your funded wallet to purchase $tun on supported platforms.</p>
                </div>
            </div>
